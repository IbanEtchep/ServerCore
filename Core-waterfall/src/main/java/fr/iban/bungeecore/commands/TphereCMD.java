...
public class TphereCMD extends Command implements TabExecutor{

	private TeleportManager tpm;

	public TphereCMD(String name, String permission, String alias, TeleportManager tpm) {
